...
* [x] Saving works (of the predetermined pages)
* [x] Table of content 'of pages' are working
* [x] Table of content of existing journal is working
* [x] Reformat the plan file so we have tickboxes.
* [x] Create 'initialize' button - pressable only once (with overwrite prompt)
    * [x] Phase 1: Just create a dedicated page per dwarf and artifact and event, so literally just the very basics of the citizen / artifact / event pages.
